...
#deploy splurge
outputFirstTokenDeployment=$(forge create src/splurge.sol:splurge --constructor-args 0xf471d32cb40837bf24529fcf17418fc1a4807626 $DeployerTags)
splurgeContract=$(echo "$outputFirstTokenDeployment" | awk -F": " '/Deployed to:/ {print $2}')
