...
#deploy splurge
splurgeDeployment=$(forge create src/contracts/splurge.sol:Splurge $DeployerTags --verify --etherscan-api-key 7CZYAQD27GJ9MZF6Y8NAQYWRKMV7E8N5SS) # arbi: YS7YS943N4358NK6AQJ411JAWCBQZXD4QA
